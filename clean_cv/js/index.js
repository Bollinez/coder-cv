  ...
  "workxp-list": [
    {
      ...
      "workxp-description-sub": [
        ...
        "application of regulatory standards … of economic downturns on portfolio-level"
      ]
    },
    {
      "department": "(Quantitative Analysis and Technology – Credit Suisse AG, Zurich)",
    ...
    },
    {
      ...
      "workxp-description": [
        "improvement of data quality for Basel III regulatory reporting purposes, by supporting the implementation ….. requests from the business side",
        "reduction of dependencies from multiple web-based BI tools with limited third-party application compatibility and … sourcing towards SQL- and Python-based queries"
      ],
      "workxp-description-sub": []
    },
    {
